...
enum opt_code
{
  ...
  OPT_mlow_precision_recip_sqrt = 1192,      /* -mlow-precision-recip-sqrt */
  OPT_mmusl = 1193,                          /* -mmusl */
  OPT_momit_leaf_frame_pointer = 1194,       /* -momit-leaf-frame-pointer */
  OPT_moverride_ = 1195,                     /* -moverride= */
  OPT_mpc_relative_literal_loads = 1196,     /* -mpc-relative-literal-loads */
